...
// import { Clock, Mail, Map, Smartphone } from 'lucide-react';
...
//                 <div className='w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative'>
//                     <div className='w-full lg:w-1/3 hidden lg:inline-block h-full bg-designColor z-0 relative'>
//                         <Image src={sliderTwo} alt='sliderOne' className='absolute object-cover right-0 lg:-right-48 h-full' priority/>
//                     </div>
//                     <div className='lg:absolute lg:top-1/2 lg:left-2/3  transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5'>
...
//                 <div className='w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative'>
//                     <div className='w-full lg:w-1/3 hidden lg:inline-block h-full bg-designColor z-0 relative'>
//                         <Image src={sliderThree} alt='sliderOne' className='absolute object-cover right-0 lg:-right-48 h-full' priority/>
//                     </div>
//                     <div className='lg:absolute lg:top-1/2 lg:left-2/3  transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5'>
...
//                     <div className="">
//                         <p>Monday - Saturday</p>
//                         <p className='font-semibold'>10am - 5pm</p>
//                     </div>
//                 </div>
...
//                     <div className="">
//                         <p>Order by Phone</p>
//                         <p className='font-semibold'>+918777429224</p>
//                     </div>
//                 </div>
...
//                     <div className="">
//                         <p>Address</p>
//                         <p className='font-semibold'>Kolkata, West Bengal</p>
//                     </div>
//                 </div>

//                 <div className="flex items-center gap-5 w-60">
//                     <Mail className='text-designColor w-8 h-8' />
//                     <div className="">
//                         <p>Mail Us</p>
//                         <p className='font-semibold'>romitdas@gmail.com</p>
//                     </div>
//                 </div>
//             </div>
//         </div>
    ...
    <div className="lg:min-h-screen relative">
      ...
      <div className="h-20 bg-white absolute left-1/2 -bottom-10 transform -translate-x-1/2 hidden lg:inline-flex items-center gap-x-12 p-10">
        <div className="flex items-center gap-5 w-60">
          ...
          <div>
            <p>Monday - Friday</p>
            <p className="font-semibold">9:00 - 17:00</p>
          </div>
        </div>
        <div className="flex items-center gap-5 w-60">
          <Smartphone className="text-designColor w-8 h-8" />
